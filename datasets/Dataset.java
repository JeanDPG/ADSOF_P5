 ...
 * y que tambien contiene un Featurizer que es el que nos permite obtener las columnas de 
 * datos, es decir las Features. Tambien puede eliminar duplicados como se explicara en dicho metodo.
 * 
...
public class Dataset<T> {
    ...
    this.data.addAll(java.util.Arrays.asList(elements));
    }
