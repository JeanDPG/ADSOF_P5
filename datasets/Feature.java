 ...
 * los valores y permite obtener el minimo, el maximo y la distribucion de esos valores.
 * 
...
public class Feature<S extends Comparable<? super S>> extends ArrayList<S> {
    ...
    /**
     * Busca el menor valor de la columna, cosa que podemos porque S extiende a Comparable.
